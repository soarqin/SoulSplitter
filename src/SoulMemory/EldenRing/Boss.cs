...
namespace SoulMemory.EldenRing
{
    public enum Boss : uint
    {
        ...
        [AnnotationAttribute(Name = "Valiant Gargoyle (Duo) - Siofra River", Description = "Siofra River")]
        ...
        [AnnotationAttribute(Name = "Abductor Virgin (Duo) - Volcano Manor", Description = "Volcano Manor")]
        ...
        [AnnotationAttribute(Name = "Putrid Crystalian (Trio) - Sellia Hideaway (Caelid)", Description = "Caelid")]
        ...
        [AnnotationAttribute(Name = "Fell Twin (Duo) - Divine Tower of East Altus (Capital Outskirts)", Description = "Capital Outskirts")]
