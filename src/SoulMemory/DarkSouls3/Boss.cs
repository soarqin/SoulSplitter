...
namespace SoulMemory.DarkSouls3
{
    ...
    public enum Boss : uint
    {
        ...
        [AnnotationAttribute(Name = "老恶魔王", Description = "熏烟湖")]
        OldDemonKing = 13800830,

        [AnnotationAttribute(Name = "教宗沙力万", Description = "冷冽谷的伊鲁席尔")]
        PontiffSulyvahn = 13700850,

        [AnnotationAttribute(Name = "巨人尤姆", Description = "罪业之都")]
        YhormTheGiant = 13900800,

        [AnnotationAttribute(Name = "吞噬神明的艾尔德利奇", Description = "亚诺尔隆德")]
        ...
        [AnnotationAttribute(Name = "妖王欧斯罗艾斯", Description = "妖王庭院")]
        OceirosTheConsumedKing = 13000830,

        [AnnotationAttribute(Name = "英雄古达", Description = "无主墓地")]
        ChampionGundyr = 14000830,

        [AnnotationAttribute(Name = "洛斯里克王子", Description = "洛斯里克城")]
        LothricYoungerPrince = 13410830,

        [AnnotationAttribute(Name = "古老飞龙", Description = "古龙顶端")]
        AncientWyvern = 13200800,

        [AnnotationAttribute(Name = "无名王者", Description = "古龙顶端")]
        NamelessKing = 13200850,

        [AnnotationAttribute(Name = "薪王们的化身", Description = "初始之火的火炉")]
        SoulOfCinder = 14100800,

        [AnnotationAttribute(Name = "芙莉德修女", Description = "艾雷德尔的绘画世界")]
        SisterFriede = 14500800,

        [AnnotationAttribute(Name = "王者的守墓人 & 守墓大狼", Description = "艾雷德尔的绘画世界")]
        ChampionsGravetenderAndGravetenderGreatwolf = 14500860,

        [AnnotationAttribute(Name = "负伤恶魔 & 洞底恶魔 / 恶魔王子", Description = "聚集地")]
        DemonInPainAndDemonFromBelowDemonPrince = 15000800,

        [AnnotationAttribute(Name = "“教堂之枪”贺弗莱特", Description = "环印城")]
